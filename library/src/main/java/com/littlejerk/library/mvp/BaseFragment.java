...
public abstract class BaseFragment extends RxFragment implements IFragment {
     ...
     */
    private boolean isDataLoaded = false;          //是否已加载数据
    private boolean isVisibleToUser = false;       //当前Fragment是否对用户可见
    private boolean isCallResume = false;          //控制ViewPager+Fragment形式下setUserVisibleHint方法导致的问题
